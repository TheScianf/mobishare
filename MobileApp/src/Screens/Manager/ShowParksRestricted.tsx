...
const ShowParksManager = () => {
    ...
    const fetchParks = useCallback(() => {
        setIsLoading(true);
        ParkManagerRequest.getParksInfoManager(isAuthenticated.token as string, isAuthenticated.username as string)
            .then(value => {
    ...
    }, [isAuthenticated.token, isAuthenticated.username]); // dipendenza token, se cambia ricalcola fetchParks
...
export default ShowParksManager;
